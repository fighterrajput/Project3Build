...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PORTFOLIO_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<font color="red" class="pl-sm-5" id="strategyError"></font>
				</div>


				<div class="col-sm-2">
					<input type="text" name="name" placeholder="Enter  Portfolio Name"
						class="form-control"
					maxlength="30"
				...
				<center>
					<div class="col-sm-2">
						<input type="submit" class="btn btn-primary btn-md"
							...
							value="<%=PortfolioListCtl.OP_SEARCH%>"> &emsp; <input
							type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
							name="operation" value="<%=PortfolioListCtl.OP_RESET%>">
					</div>
				</center>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">Portfolio Name</th>
							<th width="15%" class="text">Investment Strategy</th>
							<th width="20%" class="text">Tolerance Level</th>
							<th width="15%" class="text">Investment Amount</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getStrategy()%></td>
							<td class="text"><%=map.get(Integer.parseInt(dto.getLevel()))%></td>
							...
							<td class="text"><a
								href="PortfolioCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=PortfolioListCtl.OP_NEXT%>"
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">Portfolio
					List</h1>
			</center>
			</br>
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=PortfolioListCtl.OP_BACK%>">
				</div>
