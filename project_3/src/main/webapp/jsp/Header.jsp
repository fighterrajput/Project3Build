				...
				<%-- <li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.ABC_CTL%>"><i
							class="fas fa-calculator"></i>Add ABC</a> <a class="dropdown-item"
							href="<%=ORSView.ABC_LIST_CTL%>"> <i
							class="fas fa-sort-amount-down"></i>ABC List
					...
					<%-- 	<li class="nav-item dropdown" style="padding-left: 5px"><a
							class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
							role="button" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <font style="color: white;">System</font>

						</a>

							<div class="dropdown-menu" aria-labelledby="navbarDropdown">

								<a class="dropdown-item" href="<%=ORSView.SYSTEM_CTL%>"><i
									class="fas fa-calculator"></i>Add System</a> <a
									class="dropdown-item" href="<%=ORSView.SYSTEM_LIST_CTL%>">
									<i class="fas fa-sort-amount-down"></i>System List
						...
						<%-- <li class="nav-item dropdown" style="padding-left: 5px"><a
							class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
							role="button" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <font style="color: white;">Developer</font>

						</a>

							<div class="dropdown-menu" aria-labelledby="navbarDropdown">

								<a class="dropdown-item" href="<%=ORSView.DEVELOPER_CTL%>"><i
									class="fas fa-calculator"></i>Add Developer </a> <a
									class="dropdown-item" href="<%=ORSView.DEVELOPER_LIST_CTL%>">
									<i class="fas fa-sort-amount-down"></i>Developer List
						...
						<li class="nav-item dropdown" style="padding-left: 5px"><a
							class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
							role="button" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <font style="color: white;">Portfolio</font>
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="<%=ORSView.PORTFOLIO_CTL%>"><i
									class="fas fa-calculator"></i>Add Portfolio </a> <a
									class="dropdown-item" href="<%=ORSView.PORTFOLIO_LIST_CTL%>">
									<i class="fas fa-sort-amount-down"></i>Portfolio List
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.ORDER_CTL%>"><i
							class="fas fa-calculator"></i>Place Order </a> <a
