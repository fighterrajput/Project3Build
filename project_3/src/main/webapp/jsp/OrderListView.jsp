...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.ORDER_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="product" placeholder="Enter product"
						class="form-control"
						oninput="handleLetterInput(this, 'productError', 30)"
						onblur="validateLetterInput(this, 'productError', 30)"
						value="<%=ServletUtility.getParameter("product", request)%>">


					<font color="red" class="pl-sm-5" id="productError"></font>
				</div>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">ABC List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
