<%@page import="in.co.rays.project_3.controller.SystemCtl"%>
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Update System
							</h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-primary">Add System</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>Serial Number</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="serialNumber"
											...
											value="<%=DataUtility.getStringData(dto.getSerialNumber()).equals("0") ? ""
					: DataUtility.getStringData(dto.getSerialNumber())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5" id="serialNumberError"> <%=ServletUtility.getErrorMessage("serialNumber", request)%></font></br>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=SystemCtl.OP_UPDATE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px"
										value="<%=SystemCtl.OP_CANCEL%>">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=SystemCtl.OP_SAVE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px"
										value="<%=SystemCtl.OP_RESET%>">
								</div>
